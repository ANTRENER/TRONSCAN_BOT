...
let WalletService = (() => {
    ...
    let _classThis;
    var WalletService = _classThis = class {
        constructor(walletRepository) {
            this.walletRepository = walletRepository;
        }
        async addWallet(address, chatId) {
        ...
        async removeWallet(address, chatId) {
        ...
        async getWalletsByChatId(chatId) {
        ...
        async isWalletExists(address, chatId) {
